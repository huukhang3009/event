	...
	<table style="width: 4in;border:1px solid black;border-collapse: collapse;">
		...
		<tr>
			<td style="width:2.5in; padding:.5rem" align="left">
				<br>
				<span><strong>Tên: </strong><?php echo strtoupper($lastname.' '.$firstname.' '.$middlename) ?></span> 
				<br><br>
				<span><strong>Địa chỉ: </strong><?php echo strtoupper($address.', '.$zone.', '.$city.' City, '.$state) ?></span> <br>
			</td>
