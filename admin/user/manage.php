...
<form action="" id="people-frm">
	<div class="row">
		...
		<div class="col-md-6">
            ...
            <div class="form-group">
                <label for="type" class="control-label">Loại người dùng</label>
                <select name="type" id="type" class="custom-select custom-select-sm">
                    <option value="2" <?php echo (isset($type) && $type == 1) ? "selected" : '' ?>>Người Đăng ký</option>
                    <option value="1" <?php echo (isset($type) && $type == 1) ? "selected" : '' ?>>Quản trị</option>
                </select>
            </div>
			<div class="form-group">
