...
<form action="" id="event-frm">
	...
	<div class="form-group">
		<label for="datetime_start" class="control-label">Thời gian bắt đầu</label>
	...
	<div class="form-group">
		<label for="datetime_end" class="control-label">Thời gian kết thúc</label>
	...
	<div class="form-group">
		<label for="user_id" class="control-label">Người phụ trách</label>
	...
	<div class="form-group" style="display:none">
		<label for="limit_time" class="control-label">Giới hạn thời gian đăng ký (Tính bằng phút)</label>
