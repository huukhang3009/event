			...
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<small><b>Thời gian bắt đầu:</b> <?php echo date("M d Y h:i A",strtotime($row['datetime_start'])) ?></small><br>
							<small><b>Thời gian kết thúc:</b> <?php echo date("M d Y h:i A",strtotime($row['datetime_end'])) ?></small><br>
							<small><b>Người phụ trách:</b> <?php echo $assignee ?></small>
						</td>
						<td class="text-center">
							<?php 
							if(strtotime($row['datetime_start']) > time()): ?>
								<span class="badge badge-light">Chờ xử lý</span>
...
<script>
	$(document).ready(function(){
		$('.new_event').click(function(){
			uni_modal("Thêm sự kiện mới","./event/manage.php")
		})
