...
<form action="" id="audience-frm">
	...
	<div class="form-group">
		<label for="name" class="control-label">Tên khách mời</label>
	...
	<div class="form-group">
		<label for="remarks" class="control-label">Ghi chú</label>
	...
	<div class="form-group">
		<label for="event_id" class="control-label">Sự kiện</label>
